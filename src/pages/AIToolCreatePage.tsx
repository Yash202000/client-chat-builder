...
const AIToolCreatePage = () => {
  ...
  return (
    <div className="px-4 sm:px-8 py-4 sm:py-8 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">Create AI Tool</h1>
