...
export const WhatsappPreview: React.FC<WhatsappPreviewProps> = ({
  ...
  return (
    <div className="bg-[#E5DDD5] h-full flex flex-col">
      <div className="bg-[#075E54] p-2 text-white flex items-center">
      ...
      <div className="p-2 bg-transparent flex items-center">
        ...
        <Button onClick={handleToggleRecording} variant="ghost" size="icon" className="rounded-full ml-2 bg-green-500 hover:bg-green-600 text-white">
