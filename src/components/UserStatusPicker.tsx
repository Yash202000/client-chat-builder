...
const UserStatusPicker: React.FC<UserStatusPickerProps> = ({ user, onStatusChange }) => {
        ...
        <button className="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-muted transition-colors w-full text-left group">
          <div className="relative flex-shrink-0">
            ...
            <span className={cn(
              ...
              statusDotClass(user?.presence_status)
            )} />
          </div>
          <div className="flex-1 min-w-0">
            ...
            {user?.status_message ? (
              ...
              <p className="text-[10px] text-muted-foreground capitalize">{user?.presence_status || 'offline'}</p>
            )}
          </div>
        ...
        <div className="px-3 py-3 border-b border-border">
          <div className="flex items-center gap-2.5 mb-2.5">
            <div className="relative">
              ...
              <span className={cn('absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full border-2 border-popover', statusDotClass(user?.presence_status))} />
            </div>
            <div>
